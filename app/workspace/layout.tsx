...
.cases-heading>span{font-size:14px;color:#827b8b}
...
@media(max-width:760px){
  ...
  .workspace-header span{font-size:14px!important;white-space:nowrap}
  ...
  .mobile-menu a{flex:0 0 auto;padding:10px 12px!important;font-size:14px!important}
  ...
  .workspace-lead{font-size:16px!important;line-height:1.65!important}
  .eyebrow{font-size:12px!important;line-height:1.45!important;letter-spacing:.14em!important;overflow-wrap:anywhere}
  .notice{width:100%;max-width:100%;padding:15px 16px!important;font-size:15px!important;line-height:1.6!important;overflow-wrap:anywhere}
  ...
  .create-case-heading p{font-size:15px;line-height:1.65}
  ...
  return <div className="workspace">
    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-bottom">
        ...
        <form action={signOut}><button type="submit" style={{display:'inline-flex',alignItems:'center',gap:7,border:0,background:'transparent',padding:0,color:'#4a236f',fontWeight:700,fontSize:13}}><LogOut size={14}/> Sign out</button></form>
